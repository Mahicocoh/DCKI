const SEED_LISTINGS = [
  ...
  },
  {
    ...
    cave: 1,
    showTopFacts: true,
    topFacts: ["Entièrement rénové", "Place de parc", "Quartier calme", "Cave"],
    bathrooms: 1,
    wc: 1,
    parking: true,
    quietArea: true,
    heatingType: "Mazout",
    heatingInstallation: "Radiateurs",
    commune: "",
    access: "Au Village 2, 2855 Glovelier, Suisse",
    mapCenterLat: 47.3345676,
    mapCenterLng: 7.20449,
    characteristics: [
      { k: "Disponibilité", v: "Immédiatement" },
      { k: "Charges", v: "Comprises" },
      { k: "Type d’entrée", v: "Entrée indépendante" },
      { k: "Étage", v: "Rez-de-chaussée" },
      { k: "Pièces", v: "Studio" },
      { k: "Sanitaire", v: "1" },
      { k: "Nombre de WC", v: "1" },
      { k: "Cave", v: "1" },
      { k: "Places de parc", v: "Incluse" },
      { k: "Type de chauffage", v: "Mazout" },
      { k: "Installation chauffage", v: "Radiateurs" },
      { k: "Dernières rénovations", v: "07.2026" },
    ],
    amenityGroups: [
      {
        title: "Environnement",
