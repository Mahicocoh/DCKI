import { mountLoader } from "./loader.js?v=202605260150";
import { initI18n } from "./i18n.js?v=202605260150";
import { setActiveNav, wireForms, mountAdviceNav, mountAppointmentPlanner, mountBudgetCalculator, mountM2Calculator, mountRentMaxCalculator, mountRateCalculator, mountWhatsAppFab, mountToTopFab, mountCardGalleries, mountFavorites, mountReveals, mountHeroTopbar, mountTopbarMenu, mountCountUps, mountTestimonials, mountTypewriters, mountDossierPrefill, mountConstructionToasts, mountSmartSearch, mountCantonBubbles, mountHomeSearchRanges, mountScrollIndicators } from "./ui.js?v=202605260150";
import { initRecherche } from "./recherche.js?v=202605260150";
import { initBiens } from "./biens.js?v=202605260150";
import { initHome } from "./home.js?v=202605260150";
import { initVideoFallbacks } from "./video-fallback.js?v=202605260150";
import { initListingPage } from "./listing-page.js?v=202605260150";
