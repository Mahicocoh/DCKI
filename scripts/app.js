...
if (page === "home") loadPageScript(() => import("./home.js?v=202606164620").then((m) => m.initHome()));
...
if (page === "listing") loadPageScript(() => import("./listing-page.js?v=202606164705").then((m) => m.initListingPage()));
